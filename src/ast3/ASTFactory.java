...
public class ASTFactory extends ASTAbstract {
	...
	/**
	 * makePreixExpression represents creation of a prefix expression object
	 * @param op is operator
	 * @param exp1 is the first operand(expression)
	 * @param exp2 is the second operand(expression)
	...
	public void report() {
		...
		log.log(Level.INFO,"Number Expressions{0}",numberCount);
		log.log(Level.INFO,"Infix Expressions{0}",infixCount);
		log.log(Level.INFO,"Prefix Expressions{0}",prefixCount);
		log.log(Level.INFO,"String Expressions{0}",stringCount);
		log.log(Level.INFO,"Variable Expressions{0}",variableCount);
		log.log(Level.INFO,"Sequence Statement{0}",numberCount);
		log.log(Level.INFO,"Declaration Statement{0}",numberCount);
		log.log(Level.INFO,"Assignment Statement{0}",numberCount);
	}
